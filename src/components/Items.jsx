const items = [
  ...
  },
  {
    ...
    description:
      "A vibrant mix of colors bursting in the sky, creating a spectacular visual feast.",
    sizes: [{ size: "4 inch", price: 2400 }],
  ...
  },
  {
    ...
    sizes: [{ size: "3 Shells", price: 5000 }],
    hoverColor: "hover:shadow-pink-400/70",
  },
  {
    id: 11,
  ...
  },
  {
    ...
    sizes: [{ size: "", price: 14000 }],
    hoverColor: "hover:shadow-yellow-500/70",
  },
  {
    id: 15,
    name: "Sparkler",
    image: "/assets/Sparkler.jpg",
    video: "/assets/Sparkler.mp4",
    description: "A dazzling sparkler that lights up the night with its brilliant glow.",
    sizes: [{ size: "", price: 500 }],
    hoverColor: "hover:shadow-yellow-300/70",
  },
  {
    id: 16,
    name: "Color Shots",
    image: "/assets/ColorShots.jpeg",
    video: "/assets/ColorShots.mp4",
    description: "A vibrant display of colors bursting in the sky.",
    sizes: [{ size: "", price: 2500 }],
    hoverColor: "hover:shadow-pink-400/70",
  },
  {
    id: 17,
    name: "Crackling Shots",
    image: "/assets/CracklingShots.jpeg",
    video: "/assets/CracklingShots.mp4",
    description: "Exciting crackling effects that add a dynamic touch to any fireworks show.",
    sizes: [{ size: "", price: 2500 }],
    hoverColor: "hover:shadow-yellow-400/70",
  }
];
